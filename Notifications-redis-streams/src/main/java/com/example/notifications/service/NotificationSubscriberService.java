...
public class NotificationSubscriberService {
    ...
    public void addSubscription(String Employee_Id,String ConsumerName, String Stream) {
        activeSubscription.computeIfAbsent(Employee_Id, k -> {
            String Consumer = "Consumer_"+ConsumerName;
            String Group = "Group_"+ConsumerName;
            log.info("Creating Redis subscription for {}", k);
            return subscribeListen.subscribe(Consumer, Group, Stream);
        });
    }
